...
.PHONY: up down build logs open clean help test test-frontend test-frontend-watch test-frontend-coverage test-backend test-backend-watch run gen-meetings run-meetings
